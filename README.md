# Speech-Emotion-Recognition-using-ML/DL
...
![Link to model](Screenshots/model.png) 

*Loss and accuracy plots*

![Link to loss](Screenshots/test7_2.JPG) 

![Link to accuracy](Screenshots/test7_3.JPG)

*Classification report*

![Link do classification report](Screenshots/test7_1.JPG)

*Confusion matrix*

![Link do classification report](Screenshots/test7_4.JPG)


**How to use the code inside this repository**

1)  ```git clone https://github.com/mehulk99/SER-Model-System ``` OR, as an alternative, all the optional steps below.
